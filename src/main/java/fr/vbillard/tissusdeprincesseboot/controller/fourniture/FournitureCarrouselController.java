...
@Component
public class FournitureCarrouselController implements IModalController{
	...
	public FournitureCarrouselController(ModelMapper mapper, TissuService tissuService, StageInitializer stageInitializer) {
