  ...
  public void poidsHelp() {
    ShowAlert.information(initializer.getPrimaryStage(), "Aide", "Poids",
        "Un poids renseigné en g/m sera converti en g/m² lors de l'enregistrement (laize doit être renseigné). Un "
            + "tissu léger sera entre  0 et " + constantesMetier.getMinPoidsMoyen() + "g/m², un tissu moyen entre "
            + constantesMetier.getMinPoidsMoyen() + "g/m² et " + constantesMetier.getMaxPoidsMoyen()
            + "g/m², un tissu lourd aura un poids supérieur à " + constantesMetier.getMaxPoidsMoyen() + "g/m².");
  }
